...
" 针对不同的使用环境进行具体配置
if g:atCompany
    " set tags+=D:/Bigpao/Files/code/5399/trunk/shop.5399.com/tags
    " set tags+=D:/Bigpao/Files/code/5399/trunk/passport.5399.com/tags
    " set tags+=D:/Bigpao/Files/code/5399/trunk/new.5399.com/tags
    " set tags+=D:/Bigpao/Files/code/m5399/hd.m.5399.com/tags

    " set tags+=D:/Bigpao/Files/code/self/yii/tags
    set tags+=D:/Bigpao/Tags/tags
else
    set tags+=D:/Bigpao/Tags/tags
endif
...
let g:vimrc_author   = 'Bigpao'                " 昵称
let g:vimrc_email    = 'bigpao@gmail.com'         " 邮箱
...
if g:atCompany
    if g:isWIN
        let blog.path          = 'D:/Bigpao/Files/mysite/wiki/'
        let blog.path_html     = 'D:/Bigpao/Files/mysite/html/'
        let blog.template_path = 'D:/Bigpao/Files/mysite/templates/'
    endif
else
    if g:isWIN
        let blog.path          = 'D:/Bigpao/Files/mysite/wiki/'
